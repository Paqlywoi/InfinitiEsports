...
const Hero = () => {
  ...
  const tickerText = "/// [MATCH_REPORT]: INFINITI ESPORTS FALL TO MEGA AUTOTECH 1-2 IN MAL QUALIFIER S5 /// [MANAGEMENT_LOG]: INFINITI LOST 4 IN A ROW AND ENTERING 2026 WITHOUT A SINGLE MATCH WIN /// [APPAREL_DROPS]: THE NEW INFINITI OFFICIAL JERSEY HAS BEEN REVEALED! CHECK IT OUT NOW ON THE INFINITI OFFICIAL INSTAGRAM: @infinitiesportsmy /// [TRANSFER_RUMORS]: SPECULATION GROWS AROUND BABYNEEZY (KRONI K902) JOINING THE INFINITI 2026 ROSTER /// ";
