...
const Hero = () => {
  ...
  const tickerText = "/// [MATCH_REPORT]: INFINITI ESPORTS FALL TO MEGA AUTOTECH 1-2 /// [MANAGEMENT_LOG]: UNIT v2.0.26 DEPLOYMENT ACTIVE /// [TRANSFER_RUMORS]: SPECULATION AROUND BABYNEEZY (KRONI K902) /// ";
